...
<body>
	...
	<?php
		require_once("./js/noscriptgoogle.js");
	?>
							...
							<div class="column-geral col-sm-3" style="background-color: <?php echo $corFundo; ?>;">
								...
								<div class="botao">
									<a class="btn" data-bs-toggle="modal" onclick="carregar(id)" id="<?php echo $texto; ?>" data-bs-target="#modalBolao">
										<!--a class="btn" href="https://api.whatsapp.com/send?phone=<?php //echo $telefoneAtendimento; 
																									?>&amp;text=<?php //echo $texto
																												?>" target="_blank"-->
										<span>
											<span>
